...
# --- SLURM Preamble ---
#SBATCH --job-name=cnn-attention-multi-patient    # A descriptive name for your CNN job
...
#SBATCH --output=../logs/cnn_attn_multi_%j.out # Save logs one level up in a 'logs' folder
#SBATCH --error=../logs/cnn_attn_multi_%j.err
...
PYTHON_SCRIPT="$PROJECT_DIR/src/Classification/cnn-attention-unseen.py" # Assuming your python script is in a 'src' folder
