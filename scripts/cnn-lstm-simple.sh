...
# --- SLURM Preamble ---
#SBATCH --job-name=cnn-lstm-simple   # A descriptive name for your CNN job
...
#SBATCH --output=../logs/cnn_lstm_simple_%j.out # Save logs one level up in a 'logs' folder
#SBATCH --error=../logs/cnn_lstm_simple_%j.err
...
PYTHON_SCRIPT="$PROJECT_DIR/src/Classification/cnn-lstm-simple.py" # Assuming your python script is in a 'src' folder
