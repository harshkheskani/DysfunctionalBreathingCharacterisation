...
# --- SLURM Preamble ---
#SBATCH --job-name=cnn-attention-full-train-csr001    # A descriptive name for your CNN job
...
PYTHON_SCRIPT="$PROJECT_DIR/src/Classification/cnn-attention-full-train.py" # Assuming your python script is in a 'src' folder
